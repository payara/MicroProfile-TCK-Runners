 ...
 * holder.
 */
package fish.payara.microprofile.rest.client.tck;
...
/**
 * This archive processor adds the WiremockArquillianTest util class and
 * wiremock dependency to each archive being created by the MP-JWT TCK.
 *
 */
