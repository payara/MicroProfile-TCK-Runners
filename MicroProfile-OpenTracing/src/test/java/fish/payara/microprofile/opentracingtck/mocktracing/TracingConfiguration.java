...
/**
 * Additional config source to enable tracing and set our exporter with 10ms export frequency
 */
public class TracingConfiguration implements ConfigSourceProvider {
    @Override
    public Iterable<ConfigSource> getConfigSources(ClassLoader classLoader) {
        return Collections.singleton(MapSource.INSTANCE);
    }
